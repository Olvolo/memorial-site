        ...
        <div class="space-y-4">
            ...
            <div x-data="{ open: false }" class="bg-blue-300 rounded-lg">
                <div class="p-4 cursor-pointer" @click="open = !open">
                    <h3 class="text-xl font-semibold flex justify-between items-center">
                        ...
                        <span
                            ...
                            x-text="open ? 'Свернуть' : 'Статьи'"></span>
                    </h3>
                </div>
                ...
                <ul x-show="open" x-transition.duration.200ms
                    ...
                    <li><a href="{{ route('pyatigorsky_articles.mainly_interesting') }}"
                           class="text-black hover:text-blue-950">Главное, чтобы было интересно</a></li>
                    ...
                    <li x-data="{ lecturesOpen: false }" class="mt-2">
                        <div @click="lecturesOpen = !lecturesOpen" class="cursor-pointer flex items-center">
                            <span class="font-medium">Лекции по буддийской философии</span>
                            <span class="ml-2 text-xs px-2 py-1 bg-blue-200 rounded" x-text="lecturesOpen ? '▲' : '▼'"></span>
                        </div>
                        <ul x-show="lecturesOpen" x-transition.duration.200ms class="ml-4 space-y-1 mt-1">
                            <li><a href="{{ route('pyatigorsky_articles.buddhist_philosophia_lectures_1') }}"
                                   class="text-black hover:text-blue-950">Лекция первая</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.buddhist_philosophia_lectures_2') }}"
                                   class="text-black hover:text-blue-950">Лекция вторая</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.buddhist_philosophia_lectures_3') }}"
                                   class="text-black hover:text-blue-950">Лекция третья</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.buddhist_philosophia_lectures_4') }}"
                                   class="text-black hover:text-blue-950">Лекция четвёртая</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.buddhist_philosophia_lectures_5') }}"
                                   class="text-black hover:text-blue-950">Лекция пятая</a></li>
                        </ul>
                    </li>

                    <!-- Семинары по буддийской философии -->
                    <li x-data="{ seminarsOpen: false }" class="mt-2">
                        <div @click="seminarsOpen = !seminarsOpen" class="cursor-pointer flex items-center">
                            <span class="font-medium">Введение в изучение буддийской философии (семинары)</span>
                            <span class="ml-2 text-xs px-2 py-1 bg-blue-200 rounded" x-text="seminarsOpen ? '▲' : '▼'"></span>
                        </div>
                        <ul x-show="seminarsOpen" x-transition.duration.200ms class="ml-4 space-y-1 mt-1 grid grid-cols-1 sm:grid-cols-2 gap-1">
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_01') }}"
                                   class="text-black hover:text-blue-950">Семинар первый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_02') }}"
                                   class="text-black hover:text-blue-950">Семинар второй</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_03') }}"
                                   class="text-black hover:text-blue-950">Семинар третий</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_04') }}"
                                   class="text-black hover:text-blue-950">Семинар четвёртый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_05') }}"
                                   class="text-black hover:text-blue-950">Семинар пятый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_06') }}"
                                   class="text-black hover:text-blue-950">Семинар шестой</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_07') }}"
                                   class="text-black hover:text-blue-950">Семинар седьмой</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_08') }}"
                                   class="text-black hover:text-blue-950">Семинар восьмой</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_09') }}"
                                   class="text-black hover:text-blue-950">Семинар девятый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_10') }}"
                                   class="text-black hover:text-blue-950">Семинар десятый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_11') }}"
                                   class="text-black hover:text-blue-950">Семинар одиннадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_12') }}"
                                   class="text-black hover:text-blue-950">Семинар двенадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_13') }}"
                                   class="text-black hover:text-blue-950">Семинар тринадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_14') }}"
                                   class="text-black hover:text-blue-950">Семинар четырнадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_15') }}"
                                   class="text-black hover:text-blue-950">Семинар пятнадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_16') }}"
                                   class="text-black hover:text-blue-950">Семинар шестнадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_17') }}"
                                   class="text-black hover:text-blue-950">Семинар семнадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_18') }}"
                                   class="text-black hover:text-blue-950">Семинар восемнадцатый</a></li>
                            <li><a href="{{ route('pyatigorsky_articles.introduction_to_buddhist_philosophy_study_19') }}"
                                   class="text-black hover:text-blue-950">Семинар девятнадцатый</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div x-data="{ open: false }" class="bg-blue-200 rounded-lg">
                ...
                <ul x-show="open" x-transition.duration.200ms
                    class="list-none pl-5 space-y-2 text-base mt-3 bg-blue-200 p-4 rounded-b-lg">
                    <li><a href="{{ route('danelus_articles.about_antanas') }}"
                           class="text-black hover:text-blue-950">Об Антанасе</a>
                    </li>
                    <li><a href="{{ route('danelus_articles.beyond_space_time') }}"
                           class="text-black hover:text-blue-950">За пределами пространства и времени</a>
                    </li>
