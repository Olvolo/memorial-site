        ...
        <div class="space-y-4 sm:space-y-4">
            ...
            <div class="bg-emerald-200 p-4 sm:p-4 rounded-lg">
                ...
                <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                    <li><a href="{{ route('articles.teacher_workship') }}"
                           class="text-black hover:text-gray-700">Поклоняюсь Учителю...</a></li>
                    ...
                    <li><a href="{{ route('articles.neobuddhism_hermeneutics') }}"
                           class="text-black hover:text-gray-700">Необуддизм, герменевтическая
                            перспектива</a></li>
                    <li><a href="{{ route('articles.dandaron_tsogshin') }}"
                           class="text-black hover:text-gray-700">Цогшин Традиции Б.Д. Дандарона</a>
                    </li>
            ...
            text-green-700 text-center italic">
                ...
                <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                    ...
                    <li><a href="{{ route('articles.renormalization-i') }}"
                           class="text-black hover:text-gray-700">Перенормировка I, или
                            Кальпа-Акаша-Катастрофа</a></li>
                    <li><a href="{{ route('articles.nondual-vajrasattva') }}"
                           class="text-black hover:text-gray-700">Безначальная Ежемгновенная
                            Катастрофа Первоосознания Нетройственности</a></li>
                    <li><a href="{{ route('articles.akasha') }}"
                           class="text-black hover:text-gray-700">Акаша</a></li>
                    <li><a href="{{ route('articles.mind_and_akasha') }}"
                           class="text-black hover:text-gray-700">Вольные записи об уме и акаше</a>
                    </li>
                    <li><a href="{{ route('articles.renormalization-ii') }}"
                           class="text-black hover:text-gray-700">Перенормировка II. Посвящается
                            Каудинье</a></li>
                    <li><a href="{{ route('articles.key-matrix') }}"
                           class="text-black hover:text-gray-700">Ключ-Матрица к методу
                            Нетройственного Ваджрасаттвы</a></li>
            ...
            <div class="bg-sky-200 p-4 sm:p-4 rounded-lg">
                ...
                <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                    ...
                    <li><a href="{{ route('articles.principles_of_symbolism') }}"
                           class="text-black hover:text-gray-700">Некоторые принципы символизма
                            северного буддизма</a></li>
                    ...
                    <li><a href="{{ route('articles.vows_and_shunya') }}"
                           class="text-black hover:text-gray-700">Обеты и страх шуньевой бездны</a>
                    </li>
            ...
            text-gray-800 text-center italic">Ступа Б.Д. Дандарона</h3>
                <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                    <li><a href="{{ route('articles.stupa_construction') }}"
                           class="text-black hover:text-gray-700">Строительство Ступы Б.Д.
                            Дандарона</a></li>
                    ...
                    <li><a href="{{ route('articles.contemplation_of_stupa') }}"
                           class="text-black hover:text-gray-700">Венец небес, земли корона, или
                            Созерцание Белой Ступы Дандарона</a></li>
            ...
            <div class="bg-lime-200 p-4 sm:p-4 rounded-lg">
                ...
                <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                    <li><a href="{{ route('articles.struggle_for_datsan') }}"
                           class="text-black hover:text-gray-700">Борьба за Санкт-Петербургский
                            Дацан</a></li>
                    ...
                    <li><a href="{{ route('articles.note_addendum') }}"
                           class="text-black hover:text-gray-700">Добавление к «Аналитической
                            записке»</a></li>
                    <li><a href="{{ route('articles.alphabet_desecration') }}"
                           class="text-black hover:text-gray-700">Поругание русского алфавита</a>
                    </li>
                </ul>
            </div>
        </div>
