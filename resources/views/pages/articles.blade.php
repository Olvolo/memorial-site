    ...
    <div class="space-y-8 sm:space-y-10">
        ...
        <div class="bg-sky-200 p-4 sm:p-6 rounded-lg">
            ...
            <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                ...
                <li><a href="{{ route('articles.mahabhutas') }}" class="text-black hover:text-gray-700">Махабхути в Тантре и Абхидхарме</a></li>
        ...
        <div class="bg-fuchsia-300 p-4 sm:p-6 rounded-lg">
            <h3 class="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800 text-center italic">НЕТРОЙСТВЕННОСТЬ</h3>
            <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                <li><a href="{{ route('articles.netroystvennost') }}" class="text-blue-700 font-semibold">НЕТРОЙСТВЕННОСТЬ</a></li>
                <li><a href="{{ route('articles.golden_horse') }}" class="text-black hover:text-gray-700">Золотой Конь Бодхичитты</a></li>
                <li><a href="{{ route('articles.renormalization-i') }}" class="text-black hover:text-gray-700">Перенормировка I, или Кальпа-Акаша-Катастрофа</a></li>
                <li><a href="{{ route('articles.nondual-vajrasattva') }}" class="text-black hover:text-gray-700">Безначальная Ежемгновенная Катастрофа Первоосознания Нетройственности</a></li>
                <li><a href="{{ route('articles.akasha') }}" class="text-black hover:text-gray-700">Акаша</a></li>
                <li><a href="{{ route('articles.mind_and_akasha') }}" class="text-black hover:text-gray-700">Вольные записи об уме и акаше</a></li>
                <li><a href="{{ route('articles.renormalization-ii') }}" class="text-black hover:text-gray-700">Перенормировка II. Посвящается Каудинье</a></li>
                <li><a href="{{ route('articles.key-matrix') }}" class="text-black hover:text-gray-700">Ключ-Матрица к методу Нетройственного Ваджрасаттвы</a></li>
                <li><a href="{{ route('articles.open_horizon') }}" class="text-black hover:text-gray-700">Открытый горизонт</a></li>
                <li><a href="{{ route('articles.omniscience') }}" class="text-black hover:text-gray-700">Всеведение</a></li>
                ...
                <li><a href="{{ route('articles.ogon') }}" class="text-red-600 font-bold">ОГОНЬ</a></li>
                <li><a href="{{ route('articles.prejudice-of-earth') }}" class="text-black hover:text-gray-700">Предвзятость Земли</a></li>
            </ul>
        </div>
        ...
        <div class="bg-amber-300 p-4 sm:p-6 rounded-lg">
            <h3 class="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800 text-center italic">Добавляемые статьи</h3>
            <ul class="list-none pl-5 sm:pl-6 space-y-2 text-base sm:text-lg custom-list">
                <li><a href="{{ route('articles.secret_the_same') }}" class="text-black hover:text-gray-700">Тайна всегда одна</a></li>
                <li><a href="{{ route('articles.home') }}" class="text-black hover:text-gray-700">Дом</a></li>
                <li><a href="{{ route('articles.five_dhyanibuddhas') }}" class="text-black hover:text-gray-700">Пять Дхьянибудд и Этнический Хаос</a></li>
                <li><a href="{{ route('articles.self-liberation') }}" class="text-black hover:text-gray-700">Самоосвобождение через обнажающее внимание — Прямое Введение в ригпа</a></li>
                <li><a href="{{ route('articles.prayer-for-peace') }}" class="text-black hover:text-gray-700">Буддийское моление о мире на Балканах</a></li>
