    ...
    'articleTitle' => 'семинаров'
        ...
        <div class="text-justify text-gray-800 text-base sm:text-lg leading-relaxed space-y-6">
            ...
            <ul class="list-disc pl-6">
                <li><strong>(I)</strong> Зрительный психофизиологический комплекс, включающий в себя
                    <ul class="list-none pl-5 space-y-1 ml-8">
                        <li class="my-2">(а) орган зрения, глаз;</li>
                        <li class="my-2">(в) объект зрения;</li>
                        <li class="my-2">(с) контакт органа зрения с его объектом;</li>
                        <li class="my-2">(d) особое зрительное сознание (пали cakkhu-dhatu, санскр.
                            caksur-dhatu).
                        </li>
                    </ul>
                </li>
            ...
            <div class="citations mt-4 text-lg">
                ...
                <p class="mb-3" id="citation-2"><sup>2</sup> «Зрительные формы» (пали <i>rūpa</i>,
                    санскр. <i>rūpa</i>) — это видимые явления, воспринимаемые зрением, но не просто
                ...
                <p class="mb-3" id="citation-3"><sup>3</sup> «Зрительное сознание» (пали <i>cakkhu-viññāṇa</i>)
                    — один из шести типов сознания, возникающий при взаимодействии трёх условий:</p>
                <ul class="list-disc pl-5 space-y-1 ml-8">
                    <li>Глаза (cakkhu) как органа восприятия.</li>
                    <li>Видимого объекта (rūpa).</li>
                    <li>Направленного внимания (manasikāra).</li>
                </ul>
                ...
                <p class="mb-3" id="citation-4"><sup>4</sup> «Зрительный контакт» (пали <i>cakkhu-samphassa</i>,
                    от <i>samphassa</i>; санскр. <i>samsparśa</i>) — это момент взаимодействия
                    между:</p>
                <ul class="list-disc pl-5 space-y-1 ml-8">
                    <li>Органом зрения (глазом, <i>cakkhu</i>).</li>
                    <li>Объектом зрения (формой, <i>rūpa</i>).</li>
                    <li>Сознанием (<i>viññāṇa</i>).</li>
                </ul>
                <p>Этот контакт (<i>phassa</i>) является важным звеном в цепи условного
                    возникновения
                    страдания (<em>paṭiccasamuppāda</em>) и служит основой для возникновения чувства
                    (<i>vedanā</i>), желания или отвращения.<a href="#ref-4"
                                                               class="text-blue-500 hover:underline">↩</a>
                </p>

                <p class="mb-3" id="citation-5"><sup>5</sup> «Любая эмоция» здесь относится к так
                    называемым «чувствам» (пали <i>vedanā</i>) — второму из пяти агрегатов
                    индивидуального существования. Под <i>vedanā</i> понимается не только
                ...
                <p class="mb-3" id="citation-7"><sup>7</sup> «Ненависть» (пали <i>dosa</i>, санскр.
                    <i>dveṣa</i>) — одна из трёх коренных неблагих причин (<em>mūla-kilesa</em>),
                    наряду с
                ...
                <p class="mb-3" id="citation-8"><sup>8</sup> «Заблуждение» (пали <i>moha</i>,
                    санскр. <i>moha</i>) — фундаментальная помрачённость и искажение ума, являющаяся
                    корнем всех неблагих состояний. Оно проявляется как:</p>
                <ul class="list-disc pl-5 space-y-1 ml-8">
                    <li>неведение (<i>avijjā</i>) относительно Четырёх Благородных Истин,</li>
                ...
                <p class="mb-3" id="citation-9"><sup>9</sup> «Тело» (пали <i>kāya</i>, санскр. <i>kāya</i>)
                ...
                <p class="mb-3" id="citation-10"><sup>10</sup> «Ум» (пали <i>mano</i>, санскр. <i>manas</i>)
                    выполняет двойную функцию в буддийской психологии:</p>
                <ul class="list-disc pl-5 space-y-1 ml-8">
                    <li>Как шестой орган чувств (<i>manāyatana</i>), он воспринимает ментальные
                        объекты (<i>dhammā</i>) — такие как мысли, эмоции, идеи и другие явления
                        ума.
                    </li>
                ...
                <p class="mb-3" id="citation-11"><sup>11</sup> «Объектами ума» (пали <i>dhammārammaṇa</i>,
                    от <i>dhamma</i>) здесь называются явления, воспринимаемые шестым органом чувств
