...
@section('content')
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-justify text-base sm:text-lg leading-relaxed space-y-4">
            ...
            <p>Ответ на этот вопрос дает Стивен Хокинг, enfant terribl and darling британской
            ...
            <p>Мы читаем в текстах Абхидхармы, что мысль обусловленно возникает не только вместе со
                своим случаем, но и в данном индивидуальном континууме мысли <em>(сittasaмtana)</em>,
            ...
            <p>Смерть - это обрывание (или "отрезание") жизненной способности [<em>jlvitindriya</em>
                ...
                безвременная <em>(akalamarana)</em>... Но всякая смерть - это обрывание континуумов
                <em>(satntana)</em>... в силу действия прежних поступков <em>(karma)</em>.</p>
            ...
            <p>...Сколь краток один момент жизни! Он столь же краток, как один момент мысли [<em>cittakhana</em>,
            ...
            <p>Это отрывок из «Пути Очищения (от Скверн)» <em>(Visudd-himagga)</em>, одного из
                ...
                при чем здесь смерть?</p>

            <p>Слово «континуум» мысли имеет два значения. Во-первых, это следующие друг за другом
                серии Возникновений Мысли (cittavithi), которые обусловленно (то есть в силу
                ...
                континуум мысли - это то, внутри чего ни один «момент мысли» <em>(cittakhana)</em>
                ...
                <em>(samskaras)</em>, в общем смысле соответствующими четвертому агрегату
                ...
                следующим, будучи своего рода латентным сознанием их связи <em>(patisandhi)</em>.
                ...
                Благородной Личности, Бодхисаттвы, Будды. [Кстати, «имя» <em>(пата)</em> как термин,
